                          ...
                          <div class="cart clearfix animate-effect">
                            <div class="action">
                              <ul class="list-unstyled">
                                ...
                                <li class="lnk wishlist">  <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $item->id }}" onclick="addToWishList(this.id)"> <i class="fa fa-heart"></i> </button> </li>
