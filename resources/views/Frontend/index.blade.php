          ...
          <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
            <div class="more-info-tab clearfix ">
              ...
              <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                ...
                <li><a data-transition-type="backSlide" href="#category{{$cat->id}}" data-toggle="tab">{{ session()->get('language') == 'english' ? $cat->category_name_en : $cat->category_name_bn }}</a></li>
                @endforeach
              </ul>
              <!-- /.nav-tabs --> 
            </div>
              ...
              <div class="tab-pane in active" id="all">
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                    @foreach ($newAllproduct as $item)
                    <div class="item item-carousel">
                      <div class="products">
                        <div class="product">
                          <div class="product-image">
                            <div class="image"> <a href="{{ url('product/details/'.$item->id.'/'.$item->product_slug_en ) }} "><img  src="{{$item->product_thambnail}}" alt=""></a> </div>
                            <!-- /.image -->
...
@php
 $catwiseproduct =App\Models\Product::whereCategory_id($category->id)->whereStatus('1')->get();
@endphp
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }} "><img  src="{{$product->product_thambnail}}" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              <li class="add-cart-button btn-group">
                                <button class="btn btn-primary icon" type="button" data-toggle="modal" data-target="#exampleModal"> <i class="fa fa-shopping-cart"></i> </button>
                                <button class="btn btn-primary cart-btn" type="button">Add to cart</button>
                              </li>
...
@endphp                    
              <div class="item item-carousel">
                <div class="products">
                  <div class="product">
                    <div class="product-image">
                      <div class="image"> <a href="detail.html"><img  src="{{$item->product_thambnail}}" alt=""></a> </div>
                      <!-- /.image -->
                    ...
                    <div class="product-info text-left">
                      ...
                      <div class="rating rateit-small"></div>
                      <div class="description"></div>
                      <div class="product-price"> <span class="price"> {{$item->selling_price}}৳</span>
                        <span class="price-before-discount">{{$item->discount_price}}৳</span> </div>
                      <!-- /.product-price --> 
