    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            ...
            <div class="single-product-gallery-item" id="slide{{$img->id}}">
                <a data-lightbox="image-1" data-title="Gallery" href="{{url($img->photo_name)}}">
                    <img class="img-responsive" alt="" src="{{asset('frontend/assets/images/blank.gif')}}" data-echo="{{url($img->photo_name)}}" />
                </a>
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div id="owl-single-product-thumbnails">
				@foreach ($imgs as $img)
                <div class="item">
                    <a class="horizontal-thumb " data-target="#owl-single-product" data-slide="1" href="#slide{{$img->id}}">
                        <img class="img-responsive" width="85" alt="" src="{{asset('frontend/assets/images/blank.gif')}}" data-echo="{{url($img->photo_name)}}" />
                    </a>
                </div>
				@endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 id="pname" class="name">{{session()->get('language') == 'english' ? $p_details->product_name_en :$p_details->product_name_bn}}</h1>
...
<div class="form-group">
	@if($p_details->product_size_en == null)
 ...
 <!--     /// End Add Product Color And Product Size ///// -->
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<input type="hidden" id="product_id" value="{{$p_details->id}}">
									<div class="col-sm-7">
