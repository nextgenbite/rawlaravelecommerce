...
function productView(id){
  ...
  $.ajax({
      ...
      success:function(data){
          ...
          $('#pimage').attr('src',"{{url('/')}}/"+data.product.product_thambnail);
...
<script type="text/javascript">
   ...
   $.each(response.carts, function(key,value){
       rows += `<tr>
       <td class="col-md-2"><img src="{{url('/')}}/${value.options.image} " alt="imga" style="width:60px; height:60px;"></td>
...
///  Cart remove Start 
   function cartRemove(id){
       $.ajax({
           url: "{{url('/minicart/product-remove')}}/"+id,
           type: 'GET',
           dataType:'json',
           success:function(data){
        //    couponCalculation();
