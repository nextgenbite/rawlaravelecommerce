...
@php
$subcategories= App\Models\SubCategory::select('id','subcategory_name_en')->whereCategory_id($cat->id)->orderBy('subcategory_name_en','ASC')->get();
@endphp                   
                <div class="row">
                 ...
                 <div class="col-sm-12 col-md-3">
                   <ul class="links list-unstyled">
                     <li><a href="{{$subcat->id}}">{{$subcat->subcategory_name_en}} </a></li>
