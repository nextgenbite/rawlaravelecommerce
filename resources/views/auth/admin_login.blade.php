...
<head>
 ...
 <link rel="icon" href="{{asset('images/favicon.ico')}}">
    <title>E Shop Admin - Log in </title>
            ...
            <form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <input type="password" class="form-control pl-15 bg-transparent text-white plc-white"  name="password" required autocomplete="current-password" placeholder="Password">
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                    ...
                    <button type="submit" name="submit" class="btn btn-info btn-rounded mt-10">SIGN IN</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>														
